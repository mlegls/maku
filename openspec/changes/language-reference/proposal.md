...
- `openspec/specs/language/spec.md` stays the internal authoritative design spec; the reference derives from it and cites it, never contradicts it. Consider a status header on openspec/specs/language/spec.md marking it internal.
