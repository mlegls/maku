...
- Keep richer spellcard templates in `crates/core/lib` macros, not engine primitives (see `stdlib-touhou`).
...
- `crates/core/src/interp/` states machinery; `openspec/specs/language/spec.md` states section.
