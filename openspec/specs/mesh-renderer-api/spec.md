# mesh-renderer-api Specification

## Purpose
Defines the host-configurable Touhou render-pack contract: validated profiles, schema-bound primitive recipes, ordered reusable output, material/resource ABIs, and native/wasm host integration.
