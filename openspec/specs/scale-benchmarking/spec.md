# scale-benchmarking Specification

## Purpose
Versioned deterministic scale workloads, staged native/browser measurement, correctness gates, renderer headroom, and publication evidence.
