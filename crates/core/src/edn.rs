...
/// files under crates/core/lib/, shipped inside the engine artifact (users
/// import it; they don't edit it). One entry per library card.
const STDLIB: &[(&str, &str)] = &[
    ("@lib/prelude.maku", include_str!("../lib/prelude.maku")),
    ("@lib/touhou.maku", include_str!("../lib/touhou.maku")),
    ("@lib/player-rig.maku", include_str!("../lib/player-rig.maku")),
];
